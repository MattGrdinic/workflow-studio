...
printf "\n"
printf "  Or download the desktop app from:\n"
printf "    https://github.com/$REPO/releases\n"
printf "\n"
printf "  Configure Jira, Slack & ADO credentials in the browser UI.\n"
printf "\n"
printf "  \033[1mUpdate:\033[0m  Re-run this script to get the latest version.\n"
printf "  \033[1mUninstall CLI:\033[0m\n"
printf "    sudo rm -rf $INSTALL_DIR $BIN_LINK\n"
printf "  \033[1mUninstall desktop app:\033[0m\n"
printf "    macOS: drag Workflow Studio.app to Trash + rm -rf ~/Library/Application\\ Support/Workflow\\ Studio\n"
printf "\n"
